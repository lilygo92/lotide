...
const pantsObject = { colour: "red", length: "long" };
const anotherPantsObject = { size: "medium", shade: "red" };
assertEqual(eqObjects(pantsObject , anotherPantsObject), false); // => false
